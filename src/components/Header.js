...
<div className='w-full text-white bg-[#111921] px-2 py-1 flex items-center gap-3 relative'>
   <div className='headerHover'>
   <img src={Logo} alt="" className='w-[90px]'/>
   </div>
   <div className='headerHover p-2 '>
       <LocationOnOutlinedIcon/>
       <p className='text-sm font-light flex flex-col'>Deliver to <span className='text-sm font-bold pr-[10px]'>Pakistan</span></p>
   </div>
